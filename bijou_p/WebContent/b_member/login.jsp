...
<!--End Main Header -->
	...
	<form action="${contextPath}/member/login.do" method="post" id="h1">
	 <h1>로그인</h1>
	 <table class="login">
	 	<tr>
	 		<td><p align="left">아이디</p></td>
	 		<td><input type="text" name="member_id" class="input_box"></td>
	 	</tr>
	 	<tr>
	 		<td><p align="left">비밀번호</p></td>
	 		<td><input type="password" name="member_pw" class="input_box"></td>
	 	</tr>
	 	<tr>
	 		<td><p>&nbsp;</p></td>
	 		<td align="left">
	 			<input type="submit" value="로그인" style="width:115pt;">
	 		</td>
	 	</tr>	 		 		 		 
	 </table>
	</form>
