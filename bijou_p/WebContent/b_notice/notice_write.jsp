...
<!--Main Header-->
	...
	<form action="${contextPath}/notice/addNotice.do" method="post" id="h1" enctype="multipart/form-data">
	 <h1>글쓰기<hr></h1>
	 <table align="center">
				<tr>
					<td>글제목</td>
					<td colspan="3"><input type="text" size="67"  maxlength="500" name="notice_title" /></td>
				</tr>	
				<tr>
				...
				<tr>
					...
					<td><input type="file"  name="notice_img"  onchange="readURL(this);" /></td>
					<td id="view"></td>
				</tr> 		 		 		 
	 </table>
